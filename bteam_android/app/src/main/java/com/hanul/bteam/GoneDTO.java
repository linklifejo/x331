...
public class GoneDTO implements Serializable {
    ...
    public GoneDTO(String title, String memo, String mountin_name, String course_name, String filename, String pathname, int no, int location_no, int course_no, int resId) {
        this.title = title;
        this.memo = memo;
